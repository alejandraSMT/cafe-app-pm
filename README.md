...
---
## Introducción
Para la aplicación, se usó Flutter para el desarrollo propio de la aplicación, con el objetivo de que se pueda usar tanto en dispositivos móviles Android y iOS. Por el lado del backend, este se desarrolló en NodeJS Express y la base de datos en PostgreSQL.
